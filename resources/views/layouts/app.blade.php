...
<head>
    ...
    {{-- <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.0.0-beta3/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-eOJMYsd53ii+scO/bJGFsiCZc+5NDVN2yr8+250RDqr0Ql0h+rP48ckxlpbzKgwra6" crossorigin="anonymous"> --}}
...
<body>
    ...
    ********************-->
                    ...
                    <nav class="navbar navbar-expand">
                        <div class="collapse navbar-collapse justify-content-between">
                            ...
                            <ul class="navbar-nav header-right">
                                ...
                                <li class="nav-item dropdown notification_dropdown">
                                    <a class="nav-link bell bell-link primary" href="http://127.0.0.1:8000/front"
                                        target="_blank">
                                ...
                                <li class="nav-item dropdown notification_dropdown">
                                    <a class="nav-link bell bell-link primary" href="/reservationClient">
            ...
            <div class="deznav">
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                ...
                                <li><a href="/All/menu">Les Menu</a></li>
                                <li><a href="/All/table">Tables</a></li>
                                <li><a href="/All/servants">Servants</a></li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                ...
                                <span class="nav-text">Les Vents</span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="/payments">Add Vents</a></li>
                                <li><a href="/vents">Les Vents</a></li>
                                <li><a href="/payment/index">Toutes Les Vents</a></li>
                            </ul>
                        </li>
                        <li><a class="" href="/reports" aria-expanded="false">
                                <i class="fa fa-list text-success"></i>
                                <span class="nav-text">Rapports</span>
                            </a>
                        </li>
                        <li><a class="" href="/reservationClient" aria-expanded="false">
                                <i class="fa fa-bell" style="color: #ffc107"></i>
                                <span class="nav-text">Reservation Client</span>
                            </a>
                        </li>
                        <li><a class="" href="/allReservastion" aria-expanded="false">
                                <i class="fa fa-align-center" style="color: gray"></i>
                                <span class="nav-text">All Reservation</span>
                            </a>
                        </li>
                    ...
                    <div class="add-menu-sidebar">
                        ...
                        <a href="{{ url("create/menu") }}" class="btn btn-primary btn-block light">+ Add Menus</a>
                    </div>
                    <div class="copyright">
        ...
        <script type="text/javascript" src="{{asset('restaurant/js/modal.js')}}" charset="utf-8"></script>
